...
const Somficate: React.FC = () => {
  ...
  return (
    <section className="py-12 px-6 relative">
      <div className='absolute inset-0 blur-xl h-[580px]' style={{ background: "linear-gradient(143.6deg, rgba(229, 132, 17, 0) 10.79%, rgba(229, 132, 17, 0.26) 40.92%, rgba(229, 132, 17, 0) 70.35%)" }}></div>

      <div className="max-w-7xl mx-auto text-center mb-8">
        <h2 className="text-4xl font-extrabold text-mar">{t("catTitle")}</h2>
        <p className="mt-2 text-lg text-black font-semibold">{t("catSecond")}</p>
      </div>
      <Swiper
        spaceBetween={30}
        slidesPerView={1}
