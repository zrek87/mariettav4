      ...
      <div className="relative px-4 sm:px-8 max-w-screen-xl mx-auto z-20">
        <div className="pt-28 pb-20 px-4 flex flex-col lg:flex-row justify-between items-center">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div>
              <Link href="/somfy" className="px-8 py-3 text-sm sm:text-base bg-mar text-white font-bold rounded shadow transition duration-300 hover:text-gray-100 focus:shadow-outline">
                {t('buttonText')}
              </Link>
            </div>
          </div>
