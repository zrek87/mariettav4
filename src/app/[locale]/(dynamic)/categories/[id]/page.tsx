    ...
    <div className="max-w-6xl mx-auto p-8 bg-white rounded-xl ">
        ...
        {product.images.map((src, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
              <p className="text-white text-sm font-semibold">{`Image ${
                index + 1
              }`}</p>
            </div>
          </motion.div>
      ...
      <div className="text-center">
        <motion.h1
          ...
          className="text-6xl font-extrabold mb-4 text-gray-900 tracking-tighter leading-tight drop-shadow-md"
        >
          {t(product.title)}
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-xl text-gray-600 leading-relaxed max-w-3xl font-bold mx-auto"
        >
